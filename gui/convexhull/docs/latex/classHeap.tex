...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\+\_\+elements}} (int pos1, int pos2)
\end{DoxyCompactItemize}
\doxysubsection*{Private Attributes}
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{classHeap_ab7113bcb2f4cfadc789473e441ed70b5}\label{classHeap_ab7113bcb2f4cfadc789473e441ed70b5}} 
int $\ast$ {\bfseries idx\+\_\+heap}
\item 
\mbox{\Hypertarget{classHeap_a4407c22fa5a09ee208477370b00cff4b}\label{classHeap_a4407c22fa5a09ee208477370b00cff4b}} 
double $\ast$ {\bfseries val\+\_\+heap}
\item 
\mbox{\Hypertarget{classHeap_a6a1294b626cc4d57e3fc5666748d3012}\label{classHeap_a6a1294b626cc4d57e3fc5666748d3012}} 
int {\bfseries last\+\_\+pos}
\end{DoxyCompactItemize}
...
Definition at line 48 of file convex\+\_\+hull\+\_\+utility.\+h.
...
\DoxyCodeLine{74             this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid,pid);}
\DoxyCodeLine{75         \}}
...
\DoxyCodeLine{80             this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid,pid);}
\DoxyCodeLine{81         \}}
...
\DoxyCodeLine{153                 this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid1,pid);}
\DoxyCodeLine{154             \}}
...
\DoxyCodeLine{157                 this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid1,pid);}
\DoxyCodeLine{158             \}}
...
\DoxyCodeLine{168                 this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid1,pid);}
...
\DoxyCodeLine{174                 this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid2,pid);}
...
\DoxyCodeLine{181                 this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid1,pid);}
\DoxyCodeLine{182                 pid=cid1;}
\DoxyCodeLine{183             \}}
\DoxyCodeLine{184             \textcolor{keywordflow}{else}\{}
\DoxyCodeLine{185                 this-\/>\mbox{\hyperlink{classHeap_a03306d60e535986b3d5f698e9cf09e72}{swap\_elements}}(cid2,pid);}
...
\end{DoxyCode}
\mbox{\Hypertarget{classHeap_a03306d60e535986b3d5f698e9cf09e72}\label{classHeap_a03306d60e535986b3d5f698e9cf09e72}} 
\index{Heap@{Heap}!swap\_elements@{swap\_elements}}
\index{swap\_elements@{swap\_elements}!Heap@{Heap}}
\doxysubsubsection{\texorpdfstring{swap\_elements()}{swap\_elements()}}
{\footnotesize\ttfamily void Heap\+::swap\+\_\+elements (\begin{DoxyParamCaption}\item[{int}]{pos1,  }\item[{int}]{pos2 }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}

This function will swap the elements present in at pos1 and pos2 in both idx and val heap simultaneously.

Definition at line 90 of file convex\+\_\+hull\+\_\+utility.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{90                                          \{}
\DoxyCodeLine{95     \textcolor{comment}{//Saving the temporary}}
\DoxyCodeLine{96     \textcolor{keywordtype}{int} temp\_idx=idx\_heap[pos1];}
\DoxyCodeLine{97     \textcolor{keywordtype}{double} temp\_val=val\_heap[pos1];}
\DoxyCodeLine{98 }
\DoxyCodeLine{99     \textcolor{comment}{//Swapping the pos2 in pos1}}
\DoxyCodeLine{100     idx\_heap[pos1]=idx\_heap[pos2];}
\DoxyCodeLine{101     val\_heap[pos1]=val\_heap[pos2];}
\DoxyCodeLine{102     \textcolor{comment}{//Putting the value of pos1 at pos2 from the temp entry}}
\DoxyCodeLine{103     idx\_heap[pos2]=temp\_idx;}
\DoxyCodeLine{104     val\_heap[pos2]=temp\_val;}
\DoxyCodeLine{105 \}}
